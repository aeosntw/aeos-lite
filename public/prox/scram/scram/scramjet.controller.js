    ...
    var e = {
            129: function(e, r, t) {
                ...
                class c extends EventTarget {
                    ...
                    go(e) {
                        e instanceof URL && (e = e.toString()), n.log("navigated to", e), this.frame.src = this.controller.encodeUrl(e)
                    }
                    back() {
                ...
                let o = {
                    fmt: function(e, r, ...t) {
                        ...
                        Error.prepareStackTrace = (e, r) => {
                            ...
                            let t = "";
                            for (let e = 1; e < Math.min(2, r.length); e++) r[e].getFunctionName() && (t += `${r[e].getFunctionName()} -> ` + t);
                        ...
                        Error.prepareStackTrace = o, (console[e] || console.log)(`%c${n}%c ${r}`, `
	...
	`, `${"debug"===e?"color: gray":""}`, ...t)
            ...
            8810: function(e, r, t) {
                t.d(r, {
                    h3: () => o,
                    t8: () => c
                }), "$scramjet" in self || (self.$scramjet = {
                    version: {
                        build: "dc134c1",
                        version: "1.0.2-dev"
                    },
                    ...
                    flagEnabled: function(e, r) {
                        let t = o.config.flags[e];
                        for (let t in o.config.siteFlags) {
                            let n = o.config.siteFlags[t];
                ...
                function c() {
                    o.codec.encode = n("url", o.config.codec.encode), o.codec.decode = n("url", o.config.codec.decode)
                }
            },
            9777: function(e, r, t) {
                t.d(r, {
        ...
        window.ScramjetController = class {
            ...
            constructor(e) {
                let t = {
                    ...
                    o = (e, r) => {
                        for (let t in r) r[t] instanceof Object && t in e && Object.assign(r[t], o(e[t], r[t]));
                        return Object.assign(e || {}, r)
                    };
                r.h3.config = o(t, e)
            }
            async init() {
                (0, r.t8)(), await this.openIDB(), navigator.serviceWorker.controller?.postMessage({
            ...
            encodeUrl(e) {
                return e instanceof URL && (e = e.toString()), r.h3.config.prefix + r.h3.codec.encode(e)
            }
            decodeUrl(e) {
            ...
            async openIDB() {
                ...
                return new Promise((r, t) => {
                    e.onsuccess = async () => {
                        ...
                        let r = e.result;
                        r.objectStoreNames.contains("config") || r.createObjectStore("config"), r.objectStoreNames.contains("cookies") || r.createObjectStore("cookies")
                    }, e.onerror = () => t(e.error)
                })
            }
            async #e() {
                if (!this.db) return void console.error("Store not ready!");
                let e = this.db.transaction("config", "readwrite").objectStore("config").put(r.h3.config, "config");
                return new Promise((r, t) => {
                    e.onsuccess = r, e.onerror = t
                })
            }
            async modifyConfig(e) {
                r.h3.config = Object.assign({}, r.h3.config, e), (0, r.t8)(), await this.#e()
            }
        }
    })()
})();
