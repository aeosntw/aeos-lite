const enableAeosUpdate = false
        ...
        function showAeosUpdateOverlay(message = "aeos is updating", buttonText = "OK") {
            ...
            subText.textContent = "things might not work as intended.";
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (getCookie(cookieName)) {
                console.log("cookie present, not displaying bar.");
                return;
            }
  ...
  const blockedIPs = ['2601:40d:8201:a9e0:c94:da37:df9d:bef0', '2601:408:8000:6080:fdc3:6d1f:37af:e7d9', '206.57.198.82', '172.7.181.76', '107.147.227.238', '68.48.154.198'];
      ...
      if (blockedIPs.includes(ip)) {
        ...
        document.write(`
          ...
          <body>
            ...
            <div class="content">
              <h1>access denied.</h1>
              <p>contact the site owner if you think this is a mistake</p><br><p>for the security of our community.</p><br><br>
